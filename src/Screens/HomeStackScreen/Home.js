...
const Home = ({ navigation }) => {
    ...
    const renderitems1 = ({ item }) => {
        return (
            ...
            <View style={styles.outerbox}>
                <Image style={styles.image} source={{ uri: item.image }} onPress={() => navigation.navigate('')} />
    ...
    return (
        ...
        <ScrollView style={styles.main} >
            {/* <Ionicons name="menu-outline" color={colors.Blue} size={40} style={{ position: 'absolute', zIndex: 1 }} onPress={() => navigation.navigate('')} />
            <MaterialIcons name="chat-bubble-outline" color={colors.Blue} size={25} style={{ position: 'absolute', right: 10, top: 10, zIndex: 1 }} onPress={() => navigation.navigate('')} /> */}
            <ImageCard />
