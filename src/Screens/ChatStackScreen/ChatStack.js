...
const ChatStackScreen = (props,{route,navigation}) => (
<ChatStackScreen.Navigator screenOptions={{
        headerStyle: {
        backgroundColor: '#000'},
        headerTintColor: '#fff',
        headerTitleStyle: {
        ...
        <ChatStackScreen.Screen name="HomeScreen" component={HomeScreen} options={{title:'Home',}} />
