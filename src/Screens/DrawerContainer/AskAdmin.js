...
const AskAdmin = ({navigation:{goBack}}) => {
    ...
    const Card2 = () => {
        return (
            <View style={[styles.card, { flexDirection: 'row', justifyContent: 'space-evenly' }]}>
                ...
                <AntDesign name="youtube" color={"#EA002A"} size={35} />
            </View>
        )
    }
        ...
        return (
            <View>
                ...
                <TouchableOpacity style={styles.btn}>
                    <Text style={styles.btntext} onPress={()=>navigation.navigate('SuccessfullPostCreated')}>Send Message</Text>
